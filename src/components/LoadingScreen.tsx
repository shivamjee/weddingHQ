// A branded, non-blank loading state. PHASE1 Step 4 is explicit that the gap
// between tapping sign-in and reaching the app must NOT be a blank white screen —
// non-technical users read blank as broken.
