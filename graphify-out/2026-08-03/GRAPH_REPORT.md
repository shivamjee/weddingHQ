...
## Corpus Check
- 103 files · ~63,990 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 692 nodes · 1404 edges · 88 communities (30 shown, 58 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.68)
- Token cost: 495,673 input · 55,070 output
...
1. `useTenant()` - 43 edges
2. `useAuth()` - 35 edges
3. `useConfig()` - 24 edges
4. `toPaise()` - 21 edges
5. `tenantHref()` - 21 edges
6. `formatINR()` - 16 edges
7. `Side` - 16 edges
8. `compilerOptions` - 16 edges
9. `useLoader()` - 13 edges
10. `TextInput()` - 11 edges
...
## Communities (88 total, 58 thin omitted)

### Community 0 - "App Root & Layout"
Cohesion: 0.05
Nodes (46): geistMono, geistSans, metadata, viewport, Home(), fetchMembers(), fetchAllTenants(), fetchTenantNames() (+38 more)

### Community 1 - "Tenant Shell & More Tab"
Cohesion: 0.09
Nodes (50): TenantShell(), InviteForm(), MorePage(), CategoriesSection(), CategoryForm(), EventsSection(), ComparisonDetailPage(), Mode (+42 more)

### Community 2 - "Budget Page & Home"
Cohesion: 0.12
Nodes (37): AllocationRow(), BudgetData, BudgetPage(), SideDetail(), TotalBudgetEditor(), View, HomePage(), EventForm() (+29 more)

### Community 3 - "Tenant Config & Firestore Paths"
Cohesion: 0.09
Nodes (36): categoriesCol(), eventsCol(), byOrder(), ConfigContext, ConfigContextValue, ConfigProvider(), LoadedConfig, LoadedTenant (+28 more)
...
Cohesion: 0.12
Nodes (20): RemoveButton(), budgetDoc(), budgetTotalsDoc(), comparisonsCol(), contactDoc(), membershipDoc(), optionDoc(), questionDoc() (+12 more)
...
Cohesion: 0.14
Nodes (15): CategoryRow(), EventRow(), reorder(), SetupPage(), ColourPicker(), PageHeader(), DEFAULT_CATEGORIES, DEFAULT_EVENTS (+7 more)

### Community 12 - "Comparison Views & Criteria Editor"
Cohesion: 0.22
Nodes (18): CardsView(), computeWinners(), STATUS_STYLES, TableView(), ViewProps, NewCriterionForm(), AiChip(), bestOptionIds() (+10 more)
...
### Community 15 - "Landing & Sign-in UI"
Cohesion: 0.24
Nodes (7): Landing(), subscribeToNothing(), SignInButton(), LastTenant, readLastTenant(), readLastTenantName(), rememberLastTenant()
...
### Community 25 - "PWA vs Native Rationale"
Cohesion: 0.50
...
## Knowledge Gaps
- **199 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `printWidth`, `prettier-plugin-tailwindcss` (+194 more)
...
- **Why does `weddingHQ (product)` connect `Stack Choices & OAuth Setup` to `Rejected Backend Options`, `PWA vs Native Rationale`, `CLAUDE.md Doc Cross-references`, `README Feature Highlights`?**
